        ...
        <div class="title-box3">
            ...
            @csrf
                <h1 class="h3 mb-3 font-weight-normal">Riot Gamesでログイン</h1>
                    ...
                    <div class="signup">Riot IDをお持ちでない方 <a href="{{ url('/signup') }}" class="btn_03"><p>新規登録はこちら</p></a></div>
                    <div class="reset">パスワードをお忘れの場合 <a href="{{ url('/foget') }}" class="btn_03"><p>パスワードリセット</p></a></div>
